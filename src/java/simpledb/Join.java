...
public class Join extends Operator {
    ...
    public TupleDesc getTupleDesc() {
        ...
        Type typeAr[] = new Type[child1.getTupleDesc().numFields() + child2.getTupleDesc().numFields()];
        String fieldAr[] = new String[typeAr.length];
        for (int i = 0; i < child1.getTupleDesc().numFields(); i++) {
            typeAr[i] = child1.getTupleDesc().getFieldType(i);
            fieldAr[i] = "table1."+child1.getTupleDesc().getFieldName(i);
        }
        for (int i = 0; i < child2.getTupleDesc().numFields(); i++) {
            typeAr[i + child1.getTupleDesc().numFields()] = child2.getTupleDesc().getFieldType(i);
            fieldAr[i + child1.getTupleDesc().numFields()] = "table2."+child2.getTupleDesc().getFieldName(i);
        }
